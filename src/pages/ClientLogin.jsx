...
/* ─── Tokens (matches client app) ─── */
const C = {
  bg:"#07080F", card:"#111420", border:"rgba(255,255,255,0.07)",
  blue:"#4F8EF7", text:"#EEF2FF", sub:"#6B7591", dim:"#161926",
  f:"'Outfit',sans-serif",
};
  ...
  return (
    <div style={{ minHeight:"100vh", background:C.bg, fontFamily:C.f,
      ...
      <div style={{ textAlign:"center", marginBottom:40 }}>
        <div style={{ width:72, height:72, borderRadius:22, background:`${C.blue}20`,
          border:`2px solid ${C.blue}50`, display:"flex", alignItems:"center",
          justifyContent:"center", fontSize:36, margin:"0 auto 16px" }}>🚗</div>
        <div style={{ fontSize:32, fontWeight:900, color:C.text }}>Detailr</div>
        <div style={{ fontSize:15, color:C.sub, marginTop:6 }}>
          Professional car detailing, at your door.
        </div>
      </div>
      ...
      <div style={{ width:"100%", maxWidth:380, background:C.card,
        ...
        <div style={{ fontSize:14, color:C.sub, marginBottom:28 }}>
          Sign in to book a detailer near you
        </div>
        ...
        <div style={{ textAlign:"center" }}>
          <span style={{ fontSize:13, color:C.sub }}>Don't have an account? </span>
          <span style={{ fontSize:13, color:C.blue, fontWeight:700, cursor:"pointer" }}>
            Sign up
          </span>
        </div>
      ...
      <div style={{ display:"flex", gap:20, marginTop:32, flexWrap:"wrap",
        ...
        {["📍 Detailers come to you","⭐ Verified pros only","💳 Pay in-app securely"].map(f => (
      ...
      <div style={{ marginTop:28, textAlign:"center" }}>
        <span style={{ fontSize:13, color:C.sub }}>Are you a detailer? </span>
        <a href="/detailer-login" style={{ fontSize:13, color:C.blue,
